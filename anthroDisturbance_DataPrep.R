...
defineModule(sim, list(
  ...
  reqdPkgs = list("crayon", "ggplot2", "googledrive", "qs2", "R.utils",
                  "PredictiveEcology/reproducible", "SpaDES.core (>=2.0.3.9002)",
                  "stringi", "terra", "tictoc", "zip"),
  parameters = rbind(
    ...
    defineParameter("whatNotToCombine", "character", "potential", NA, NA,
                    paste0("Here the user should specify which dataClass from ",
                           ...
                           "i.e., potentialResourcesYT_DataPrep). This parameter ",
  ...
  outputObjects = bindrows(
    ...
    createsOutput(objectName = "disturbanceList", objectClass = "list",
                  desc = paste0("List (general category) of lists (specific ",
                                ...
                                "current defaults, this is the potentialResourcesYT_DataPrep",
